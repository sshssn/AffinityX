            ...
            <CardContent className="space-y-4 sm:space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base">contact@affinityx.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-gray-900 dark:text-white text-sm sm:text-base">Phone</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-gray-900 dark:text-white text-sm sm:text-base">Address</p>
                  <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base">123 Innovation Drive, Tech City, TC 12345</p>
                </div>
              </div>
            </CardContent>
          </Card>
