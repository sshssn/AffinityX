...
const Icons = {
  ...
  convex: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 32 32" fill="none" {...props}>
      <path d="M16 2L2 9L16 16L30 9L16 2Z" fill="#00D4AA"/>
      <path d="M2 23L16 30L30 23L16 16L2 23Z" fill="#00D4AA"/>
      <path d="M2 9V23L16 16V2L2 9Z" fill="#00D4AA" fillOpacity="0.8"/>
      <path d="M16 2V16L30 9L16 2Z" fill="#00D4AA" fillOpacity="0.6"/>
    </svg>
  ),
