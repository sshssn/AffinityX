...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  const handleFormSignIn = (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();
    if (onSignIn) {
      onSignIn(event);
    } else {
      // Placeholder for form sign-in logic
      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={handleFormSignIn}>
            ...
            <div className="animate-element animate-delay-800 space-y-3">
              <button 
